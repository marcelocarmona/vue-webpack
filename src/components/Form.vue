<template>
  <form @submit.prevent="validateBeforeSubmit">
    ...
    <div class="column is-12">
      ...
      <p class="control has-icon has-icon-right">
        <input name="name" v-model="name" v-validate:name.initial="'required|alpha'" :class="{'input': true, 'is-danger': errors.has('name') }"
    ...
    <div class="column is-12">
      ...
      <p class="control has-icon has-icon-right">
        <input name="url" v-model="url" v-validate:url.initial="'required|url'" :class="{'input': true, 'is-danger': errors.has('url') }"
